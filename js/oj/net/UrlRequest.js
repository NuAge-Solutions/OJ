...
OJ.compileClass(
	'OjUrlRequest',
	oj.net.UrlRequest = function(){
		return new oj.net.Url(
			arguments, 'OjUrlRequest',
			{
				'_properties_' : {
					'data'        : null,
					'files'       : null,
					'headers'     : null,
					'method'      : OjUrlRequest.GET
				},
	...
	},
	{
		...
		//'USE_ACTIVEX' : !window.XMLHttpRequest && (window.location.protocol === 'file:' && OJ.HAS_ACTIVEX),
		'USE_ACTIVEX' : false,
