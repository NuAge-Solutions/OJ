...
OJ.importJs('oj.utils.CacheObject');
OJ.importJs('oj.utils.CachePolicy');
...
OJ.compileManager(
	'CacheManager',
	oj.utils.CacheManager = function(){
		return new oj.events.Actionable(
			arguments, 'OjCacheManager',
			{
				// lifespans
				'MINUTE'  : 60,
				'HOUR'    : 3600,
...
//					}
				...
				'setLocalData' : function(key, value/*, lifespan*/){
					...
					this._setLocalData(key, new OjCacheObject(value, ln > 2 ? arguments[2] : null));
				},
